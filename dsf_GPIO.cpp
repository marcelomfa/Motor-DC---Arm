...
void dsf_GPIO::gpio_direction(uint8_t port, uint8_t pin, uint8_t mode,bool pull_resistor)
{
	switch(port)
	{
		case PORT_A:
...
void dsf_GPIO::gpio_set(uint8_t port, uint8_t pin, uint8_t value)
{
	switch(port)
	{
		case PORT_A:
...
void dsf_GPIO::gpio_toggle(uint8_t port, uint8_t pin)
{
	switch(port)
	{
		case PORT_A:
...
uint16_t dsf_GPIO::gpio_read(uint8_t port, uint8_t pin)
{
	switch(port)
	{
		case PORT_A:
