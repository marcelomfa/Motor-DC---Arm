...
int main(void) {
   ...
   */
  dsf_PWM_ocp pwm_led_verde, pwm_led_vermelho, pwm_led_azul;
  dsf_DCMotor mdc;

  /*!
   *  Chamada das função do objeto pwm_led_verde
   */
  pwm_led_vermelho.bindPeripheral(TPM2_BASE_PTR);
  pwm_led_vermelho.bindChannel(0);
  pwm_led_vermelho.bindPort(GPIOB, 18);
  pwm_led_vermelho.setFrequence(100);
  pwm_led_vermelho.setDutyCycle(50);
  pwm_led_vermelho.enableOperation();

  /*!
   *  Chamada das função do objeto pwm_led_verde
   */
  pwm_led_verde.bindPeripheral(TPM2_BASE_PTR);
  pwm_led_verde.bindChannel(1);
  pwm_led_verde.bindPort(GPIOB, 19);
  pwm_led_verde.setFrequence(100);
  pwm_led_verde.setDutyCycle(50);
  pwm_led_verde.enableOperation();
  ...
  for ( ; ; ) {
    ...
    */
    pwm_led_vermelho.setDutyCycle(DUTY_MAX-x);
    pwm_led_verde.setDutyCycle(x);
    mdc.setSpeed(x);
